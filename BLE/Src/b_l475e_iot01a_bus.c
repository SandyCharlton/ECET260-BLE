...
/** @defgroup B_L475E_IOT01A_BUS_Exported_Variables BUS Exported Variables
  * @{
  */
...
/** @defgroup B_L475E_IOT01A_BUS_Private_Variables BUS Private Variables
  * @{
  */
...
/** @defgroup B_L475E_IOT01A_BUS_Private_FunctionPrototypes  BUS Private Function
  * @{
  */  
